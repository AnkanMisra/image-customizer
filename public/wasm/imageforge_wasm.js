/* @ts-self-types="./imageforge_wasm.d.ts" */
 ...
 * @returns {Uint32Array}
 */
export function get_dimensions(input_bytes) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray8ToWasm0(input_bytes, wasm.__wbindgen_export);
        const len0 = WASM_VECTOR_LEN;
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('imageforge_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
